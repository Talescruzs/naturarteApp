package com.example.naturarte.ui.arquiteto;
...
import com.example.naturarte.databinding.FragmentArquitetoBinding;
import com.example.naturarte.sqlHelper;

public class ArquitetoFragment extends Fragment {
    private FragmentArquitetoBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentArquitetoBinding.inflate(inflater, container, false);
    ...
    public void insere(View view){
        ...
        long id_table = sqlHelper.getInstance(getActivity()).addRegistro("arquiteto",nomeInserido,especialidadeInserida, salarioFinal);
        if (id_table>0) {
